...
$route['class_list'] = 'web/class_index';
$route['subject_list'] = 'subject/index';
$route['class_routine_create'] = 'web/class_routine_create';
$route['class_create'] = 'web/class_create';
