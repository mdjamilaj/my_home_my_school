            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_content">
                    ...
                    <div class="table-responsive">
                        <?php if (isset($sn) || isset($sub_name1) || isset($cretor1) || isset($class_id1)) { ?> <p style="background: #000000; color: #ffffff;text-align: center;font-size: 16px;font-weight: 600;padding: 4px; width:550px; float: left; text-aling: center;"><?php if(isset($sn)){echo "Sn : ".$sn;} if(isset($sub_name1)){echo "&nbsp;&nbsp;&nbsp; Class Name : ".$sub_name1;} if(isset($creator1)){echo "&nbsp;&nbsp;&nbsp; Creator : ".$creator1;} if(isset($class_id1)){echo "&nbsp; &nbsp; &nbsp; Class Id : ".$class_id1;}  }?> </p>
