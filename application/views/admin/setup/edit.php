                ...
                <div class="card-body p-0">
                  ...
                  <div class="row justify-content-center">
                    <div class="col-lg-8 justify-content-center x_panel">
                      <div class="p-5">
                        <form class="user" action="<?php echo base_url() ?>web/class_routine_update" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-6 mb-3 mb-sm-0">
                              ...
                              <select required class="form-control" name="sub_id" id="subject">
                                ...
                                <?php foreach ($data2 as $key => $show_data) { ?>
                                  <option value="<?php echo $show_data['sub_id']; ?>" <?php if ($edit_data->class_id == $show_data['class_id'] && $edit_data->sub_id == $show_data['sub_id']) {
                                                                                        echo "selected";
                                                                                      } ?>><?php echo $show_data['sub_name']; ?></option>
                                <?php } ?>
                              </select>
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            <div class="col-sm-4 mb-3 mb-sm-0">
                              ...
                              <input type="text" value="<?php echo $edit_data->video_link; ?>" autocomplete="off" name="video_link" class="form-control form-control-user" required id="notice_date" placeholder="Video Link ..">
                            </div>
                            <div class="col-sm-4 mb-3 mb-sm-0">
                            ...
                            <div class="col-sm-4 mb-3 mb-sm-0">
                              ...
                              <div class="flatpickr" id="rangeDate" class="form-control form-control-user">
                                <input type="text" value="<?php echo $edit_data->date_time; ?>" placeholder="Select Date.." required name="date_time" data-input> <!-- input is mandatory -->
                          ...
                          <input type="hidden" name="file_url" value="<?php echo $edit_data->attachment; ?>">
