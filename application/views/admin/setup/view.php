            ...
            <span class="input-group-btn">
              <button class="btn btn-default" type="button">Go!</button>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 form-group ">
                    <a href="<?php echo  base_url() ?>class_routine_create" class="btn btn-primary btn-user btn-block">Routine Create</a>
                </div>
            </div>
        </div>
                                                        ...
                                                        <div class="col-sm-4 mb-3 mb-sm-0">
                                                            ...
                                                            <div class="col-md-8 col-sm-4 col-xs-12">
                                                                <div class="flatpickr" id="rangeDate" class="form-control form-control-user">
                                                                    <input style="width: 79%;" type="text" placeholder="Select Date Time .." name="date_time" data-input> <!-- input is mandatory -->
                                ...
                                <tbody class="text-center">
                                    ...
                                    foreach ($details as $show_data) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-left"><?php echo $show_data['video_link']; ?></td>
